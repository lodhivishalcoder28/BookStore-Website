...
const Banner = () => {
  return (
    ...
    <div className='max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-3'>
        ...
        <p className='text-xl'>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto, ex ipsam aut laboriosam esse commodi quaerat ipsum deleniti cum ab. Modi inventore reprehenderit incidunt quae adipisci voluptatum ipsum! Et, cumque?
        </p>
  ...
  <input type="text" className="grow" placeholder="Email" />
        ...
        {/* //right part is here  */}
        <div className='md:order-2 order-1 w-full md:w-1/2 md:mt-32 md:ml-32'>
